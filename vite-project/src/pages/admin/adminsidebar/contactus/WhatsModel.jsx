...
import "../../../../assets/admincss/sidebarcss/contactus/contactwhatsupmessage.css";
    ...
    return (
        ...
        <div className="whatsapp-support-overlay mt-5">
            ...
            <div className="whatsapp-support-container">
                ...
                <button className="replydesk-close-btn call-support-close-btn" onClick={() => navigate("/contactadmin")}>
                    ✕
                </button>
