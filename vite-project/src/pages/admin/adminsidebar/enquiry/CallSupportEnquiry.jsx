...
import "../../../../assets/admincss/sidebarcss/enquery/callsupport.css";
import { useNavigate, useParams } from "react-router-dom";

export default function CallSupportModalEnquiry({ item, onClose }) {
    ...
    return (
        ...
        <div
            className={`call-support-overlay ${closing ? "call-support-overlay-closing" : ""
                }`}
        >

            <div
                className={`call-support-container ${closing ? "call-support-container-closing" : ""
                    }`}
            >
                ...
                <div className="call-support-footer">
                    ...
                    <button className="call-missed-btn">
